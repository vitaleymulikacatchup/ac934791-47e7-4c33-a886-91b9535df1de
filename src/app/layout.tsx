...
export const metadata: Metadata = {
  title: "FAFO - Spontaneous Hawaiian Adventures",
  description: "Discover authentic Hawaii through spontaneous travel experiences. Book your F*ck Around and Find Out island adventure today.",
  keywords: ["Hawaii travel", "spontaneous adventure", "island vacation", "Oahu", "Maui", "Big Island", "Kauai", "travel agency"],
  metadataBase: new URL("https://fuckararoundandfindout.com"),
  alternates: {
    canonical: "https://fuckararoundandfindout.com"
  },
  openGraph: {
    title: "FAFO - Spontaneous Hawaiian Adventures",
    description: "Escape the ordinary. Embrace the unexpected. FAFO connects adventurous travelers with authentic Hawaiian experiences.",
    url: "https://fuckararoundandfindout.com",
    siteName: "FAFO Travel",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766071500610-bci3nm5b.jpg",
      alt: "Tropical Hawaiian sunset"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "FAFO - Spontaneous Hawaiian Adventures",
    description: "Book your spontaneous island escape with FAFO Travel.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766071500610-bci3nm5b.jpg"]
  },
  robots: {
    index: true,
    follow: true
